...
deerror = aerror * 0.4
inerror = aerror * 0.17
parser = argparse.ArgumentParser(description="JSCC-DNA")
...
parser.add_argument('--save_dir', type=str, default='./model_data_2/L175__C1_5__r0_125', metavar='N', help='model saving directory')
parser.add_argument('--resume', type=str, default='./model_data_2/L175__C1_5__r0_125/checkpoint.pth', metavar='PATH', help='path to latest checkpoint(default: None)')
parser.add_argument('--result_dir', type=str, default='./model_data_2/Result__L175__C1_5__r0_125', metavar='DIR', help='output directory')
parser.add_argument('--a_loss', type=int, default=175, help='loss function parameter')
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for step, (x, y) in enumerate(train_dataloader):
            ...
            if step % (len(train_dataloader) // 2) == 0:
                ...
                print("RLL567+:", ll5, ll6, ll7, "AG:", AGCT_rate, "PSNR={:.4f}".format(20 * math.log10(255 / math.sqrt(MSE))), "ssim:{:.4f}".format(ssim_iando), "ms-ssim:{:.4f}".format(msssim_iando))
